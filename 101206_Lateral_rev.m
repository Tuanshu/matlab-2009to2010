...
data_o=importdata('D:\101122_spec array (20k, 0.2)_ali4_1(with p).txt');
...
clear maxs_2d;
maxs=max(CS_envelope(2000:12000,1:200),[],1);
maxs_2d(1:10001,1:200)=0;
for j=1:200
    maxs_2d(:,j)=maxs(j);
end
%imagesc(10*log10(CS_envelope./maxs)); figure(gcf)
imagesc(10*log10(CS_envelope(2000:12000,1:200)./maxs_2d),'xdata',[0:25:25*81],'ydata',[0:0.009375850226843:0.009375850226843*3001]); figure(gcf);
