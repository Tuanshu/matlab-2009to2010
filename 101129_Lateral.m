...
data_o=importdata('D:\101206_lateral (1k 1) set5(rot) -1.txt');
...
clear maxs_2d;
maxs=max(CS_envelope(2000:20000,10:400),[],1);
maxs_2d(1:18001,1:391)=0;
for j=1:391
    maxs_2d(:,j)=maxs(j);
end
%imagesc(10*log10(CS_envelope./maxs)); figure(gcf)
imagesc(10*log10(CS_envelope(2000:20000,10:400)./maxs_2d),'xdata',[0:25:25*81],'ydata',[0:0.009375850226843:0.009375850226843*3001]); figure(gcf);
