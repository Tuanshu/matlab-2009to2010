...
data_o=importdata('D:\110131_lateral grating (1 1000 1000).txt');
...
inter_index_FD(j)=inter_peakindex_FD+space_min_for_inter_peak_index_FD-1;
...
clear maxs_2d;
maxs=max(CS_envelope(4000:7000,1:60),[],1);
maxs_2d(1:20000,1:60)=0;
for j=1:60
    maxs_2d(:,j)=maxs(j);
end
imagesc(10*log10(CS_envelope(1:20000,1:60)./maxs_2d)); figure(gcf)
%imagesc(10*log10(CS_envelope(10000:12000,1:200)./maxs_2d),'xdata',[0:25:25*81],'ydata',[0:0.009375850226843:0.009375850226843*3001]); figure(gcf);
